  ...
  <vui-stepper :activeStep="activeStep" orientation="vertical">
    <vui-step>
      ...
      <vui-step-content>
        ...
        <vui-raised-button label="下一步" class="demo-step-button" @click="handleNext" primary/>
      </vui-step-content>
    </vui-step>
    <vui-step>
      <vui-step-label>
      ...
      <vui-step-content>
        ...
        <vui-raised-button label="下一步" class="demo-step-button" @click="handleNext" primary/>
        <vui-flat-button label="上一步" class="demo-step-button" @click="handlePrev"/>
      </vui-step-content>
    </vui-step>
    <vui-step>
      <vui-step-label>
      ...
      <vui-step-content>
        ...
        <vui-raised-button label="完成" class="demo-step-button" @click="handleNext" primary/>
        <vui-flat-button label="上一步" class="demo-step-button" @click="handlePrev"/>
      </vui-step-content>
    </vui-step>
  </vui-stepper>
