<template>
<div>
  <vui-button primary label="上面弹出" @click="open('top')"/>
  <vui-button primary label="下面弹出" @click="open('bottom')"/>
  ...
  <vui-popup position="top" :overlay="false" popupClass="demo-popup-top" :open="topPopup">
    更新成功
  </vui-popup>
